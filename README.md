...
Para comenzar a introducir al alumno en esta mecánica práctica se pue- de plantear un primer ejercicio: “resuelva el problema de mover el caballo de ajedrez sobre el tecla- do de un teléfono”.
